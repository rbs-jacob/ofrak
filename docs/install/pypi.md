...
- Python 3.9+ and pip
- cmake and libmagic (macOS only - install via `brew install cmake libmagic` - libmagic 5.47 has a known regression affecting ELF identification, ensure libmagic!=5.47 after installing; see [source install docs](source.md#macos-libmagic-install) for more information)
